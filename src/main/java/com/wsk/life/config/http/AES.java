package com.wsk.life.config.http;
...
public class AES {
    ...
    public static String getParams(String text) throws Exception {
        ...
        String hEnctext = com.wsk.life.config.http.AES.encrypt(text, firstKey);
        hEnctext = com.wsk.life.config.http.AES.encrypt(hEnctext, secondKey);
        return hEnctext;
    }
...
//        System.out.print("请输入要解析的音乐ID：");
        ...
        System.out.println("params=" + URLEncoder.encode(com.wsk.life.config.http.AES.getParams(first_param), "UTF-8") + "&encSecKey=" + com.wsk.life.config.http.AES.getEncSecKey());
    }
}
