...
public class Down {
    ...
    public static String randomName(String fileName){
        return Tool.getInstance().getRandom() + com.wsk.life.config.tool.OnlyOneId.getOnlyOneId() + subFileName(fileName);
    }
    ...
    public static void main(String[] args) {
        ...
        try {
            System.out.println(com.wsk.life.config.tool.OnlyOneId.getOnlyOneId());
            System.out.println(com.wsk.life.config.tool.OnlyOneId.getOnlyOneId());
            System.out.println(com.wsk.life.config.tool.OnlyOneId.getOnlyOneId());
            System.out.println(com.wsk.life.config.tool.OnlyOneId.getOnlyOneId());
            System.out.println(com.wsk.life.config.tool.OnlyOneId.getOnlyOneId());
