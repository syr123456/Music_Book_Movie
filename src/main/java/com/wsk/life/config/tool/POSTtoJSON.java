...
public class POSTtoJSON {
    private static class Lazy {
        private static final com.wsk.life.config.tool.POSTtoJSON INSTANCE = new com.wsk.life.config.tool.POSTtoJSON();
    }
    ...
    public static final com.wsk.life.config.tool.POSTtoJSON getInstance() {
...
//        map.put("q", "泰坦尼克号");
//        String wsk = com.wsk.life.config.tool.POSTtoJSON.getInstance().post("https://api.douban.com/v2/movie/search", map,"GET");
    }
}
