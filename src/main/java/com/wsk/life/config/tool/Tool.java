...
//import com.wsk.life.config.tool.bean.Baidu;
...
//    private Lock lock = new ReentrantLock();
    ...
    private static class Lazy {
        private static final com.wsk.life.config.tool.Tool TOOL = new com.wsk.life.config.tool.Tool();
    }

    public static com.wsk.life.config.tool.Tool getInstance() {
        return Lazy.TOOL;
    }
    ...
    private ArrayList<String> readTxt() throws IOException {
        ...
        String encoding = "GBK";
        String path = "D:\\Movie\\images\\txt\\all.txt";
        File file = new File(path);
        if (!file.exists()) {
            path = "D:\\Movie\\images\\txt\\all.txt";
            file = new File(path);
        }
