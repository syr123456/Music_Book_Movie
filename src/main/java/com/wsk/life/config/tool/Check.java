...
public class Check {
    private static final String POST_URL = "https://aip.baidubce.com/rest/2.0/ocr/v1/general_basic?access_token=" + com.wsk.life.config.tool.AuthService.getAuth();
    ...
    public static void main(String[] args) {
        String path = "D:\\Movie\\images\\2.jpg";
        try {
