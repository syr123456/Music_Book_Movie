...
//    private static final Map<String, Long> map2 = new HashMap<>();
    ...
    private static class LaySaveSession {
        private static final com.wsk.life.config.tool.SaveSession instance = new com.wsk.life.config.tool.SaveSession();
    }


    public static com.wsk.life.config.tool.SaveSession getInstance() {
